...
<div id="respond">
	...
	<?php else : //No registration required ?>
		...
		<p>
			<label for="comment"><?php _e( 'Your Comment', 'woothemes' ); ?><span class="bg">&nbsp;</span></label>
