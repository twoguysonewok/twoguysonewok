...
class WooDojo_Model_Main extends WooDojo_Model {
	...
	public function component_actions () {
		...
		if ( isset( $_REQUEST['activate-component'] ) && ( $_REQUEST['activate-component'] != '' ) ) {
			$response = $this->activate_component( trim( esc_attr( $_REQUEST['activate-component'] ) ), trim( esc_attr( $_REQUEST['component-type'] ) ) );
		}
		
		// Component deactivation.
		if ( isset( $_REQUEST['deactivate-component'] ) && ( $_REQUEST['deactivate-component'] != '' ) ) {
			$response = $this->deactivate_component( trim( esc_attr( $_REQUEST['deactivate-component'] ) ), trim( esc_attr( $_REQUEST['component-type'] ) ) );
		}
		
		// Component download.
		if ( isset( $_REQUEST['download-component'] ) && ( $_REQUEST['download-component'] != '' ) ) {
			$response = $this->download_component( trim( esc_attr( $_REQUEST['download-component'] ) ), trim( esc_attr( $_REQUEST['component-type'] ) ) );
		}

		// Component purchase.
		if ( isset( $_REQUEST['purchase-component'] ) && ( $_REQUEST['purchase-component'] != '' ) ) {
			$response = $this->purchase_component( trim( esc_attr( $_REQUEST['component'] ) ), trim( esc_attr( $_REQUEST['component-type'] ) ) );
		}

		// Component upgrade.
		if ( isset( $_REQUEST['upgrade-component'] ) && ( $_REQUEST['upgrade-component'] != '' ) ) {
			$response = $this->upgrade_component( trim( esc_attr( $_REQUEST['upgrade-component'] ) ), trim( esc_attr( $_REQUEST['component-type'] ) ) );
		}
	...
	public function add_contextual_help () {
		...
		*/
		...
		'<p><a href="http://woothemes.com/support-forum/?ref=' . $this->config->token . '" target="_blank">' . __( 'Support Forums', 'woodojo' ) . '</a></p>' . 
		'<p><a href="http://woothemes.com/support/woodojo/?ref=' . $this->config->token . '" target="_blank">' . __( 'WooDojo Documentation', 'woodojo' ) . '</a></p>'
		);
