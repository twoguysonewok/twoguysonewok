...
Description: Minifiy those URLs!
...
- function short_url_filter
- function shorten_url
- function shorten_url_tinyurl
- function shorten_url_bitly
...
class WooDojo_ShortLinks {
	...
	public function shorten_url_bitly ($url) {
	    ...
	    if ( ( $login != '' ) && ( $api_key != '' ) ) {
	    	$url = 'http://api.bitly.com/v3/shorten/?login=' . $login . '&apikey=' . $api_key . '&format=json&longUrl=' . urlencode($url);
